Describe("Nameplate stacking", function()
    It("uses compact vertical row separation", function()
        ...
        ExpectEqual(settings.nameplateShowOffscreen, "0")
        ExpectEqual(settings.nameplateTargetRadialPosition, "0")
        ExpectEqual(settings.nameplateTargetBehindMaxDistance, "0.1")
    end)
    ...
    It("applies every stacking CVar outside combat", function()
        ...
        ExpectEqual(applied.nameplateShowOffscreen, "0")
        ExpectEqual(applied.nameplateTargetRadialPosition, "0")
        ExpectEqual(applied.nameplateTargetBehindMaxDistance, "0.1")
    end)
