Describe("Fixed Jundies presentation", function()
    It("uses the exported hostile plate dimensions", function()
        ...
        ExpectEqual(config.colors.tapDenied[1], 0.5)
        ExpectEqual(config.colors.tapDenied[2], 0.5)
        ExpectEqual(config.colors.tapDenied[3], 0.5)
        ExpectEqual(config.colors.tapDenied[4], 1)
